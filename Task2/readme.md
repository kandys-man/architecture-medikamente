...
## Для MVP 
 ...
 1. Перенести реестры анализов, журналы регистрации, файлы со списками пациентов и их профайлами на защищенные диски 
 2. Настроить Apache NiFi для переноса данных п.1 в защищенное хранилище данных на PosgreSQL(ключевая информация) и ClickHouse(неструктурированные данные)
 3. Создать микросервис для чтения данных из хранилища п.2 и с возможностью записи к врачу
 4. Создать BFF для сотрудника ресепшена и BFF для мобильного приложения
 5. Добавить API Gateway(Kong) между BFF п.4 и микросервиса из п.3
 6. Создать https-портал с ЛК пациента
...
|:-|:-|:-|:-|:-|:-|
|Реестры анализов   |ClickHouse|В соответствии с законодательством|По требованию клиента|Шифрование (AES-256)|TLS-шифрование|
