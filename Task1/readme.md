...
|Медицинские карты (Адрес прописки, место работы или учёбы, заболевания клиента, приемы у врачей|Конфиденциальные|Шифрование (AES-256)|Хранение в зашифрованном виде|
